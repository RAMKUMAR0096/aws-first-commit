      ...
      <div className="glass-panel flex flex-col justify-between gap-4 rounded-2xl p-5 sm:flex-row sm:items-center sm:p-6">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-white sm:text-2xl">
              Application Tracker (AWS DynamoDB)
            </h2>
          </div>
          <p className="mt-1 text-xs text-slate-300">
            Real-time job application pipeline backed by AWS DynamoDB table{" "}
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-emerald-500 px-4 py-2 text-xs font-semibold text-white shadow-md transition-all hover:scale-105 active:scale-95"
          >
        ...
        >
          <div className="flex items-center justify-between pb-2 border-b border-slate-800">
            <h3 className="font-bold text-white text-sm sm:text-base flex items-center gap-2">
              ...
              <span>Add Job Application to DynamoDB</span>
            </h3>
            <span className="text-xs text-slate-400">All fields persisted automatically</span>
          </div>
